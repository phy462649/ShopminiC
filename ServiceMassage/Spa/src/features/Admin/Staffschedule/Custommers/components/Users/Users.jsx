...
export default function Users() {
  ...
  // Sync fetched data
  useEffect(() => {
    if (fetchedData) setCustomersList(fetchedData);
  }, [fetchedData]);

  const handleAdd = () => setFormAddOpen(true);
  const handleCloseForm = () => setFormAddOpen(false);
    ...
    <div className="p-4">
      <div className="mb-4 flex items-center">
        ...
        <div className="flex mx-8">
          ...
          <button
            className="px-4 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 mx-4"
            disabled
          >
            Sửa
          </button>
