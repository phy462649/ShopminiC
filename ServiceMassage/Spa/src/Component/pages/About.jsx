      ...
      <section className="py-20 bg-pink-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div>
              <h2 className="text-4xl md:text-5xl font-serif text-pink-600 mb-8 leading-relaxed">
                Spa là gì?
              </h2>
              
              {/* Decorative lotus */}
              <div className="text-pink-400 text-3xl mb-8">❀</div>
              
              <p className="text-pink-700 text-lg mb-6 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="space-y-5 pt-10">
                ...
                />
                {/* Years Badge */}
                <div className="bg-pink-600 text-white rounded-xl p-8 text-center shadow-lg">
                  <p className="text-5xl font-bold font-serif">21 năm</p>
                  <div className="w-px h-10 bg-white/50 mx-auto my-3"></div>
                  <p className="text-base">cống hiến cho khách hàng</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            {/* Left Column - Title */}
            <div>
              <h2 className="text-5xl font-serif text-pink-600 mb-8">Spa mang lại lợi ích gì?</h2>
              <div className="text-pink-400 text-3xl mb-8">❀</div>
              <p className="text-pink-700 text-lg leading-relaxed">
            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-5">
                <div className="w-20 h-20 bg-pink-600 rounded-xl flex items-center justify-center flex-shrink-0">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-pink-600 mb-3">Khứu giác</h3>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-pink-600 mb-3">Vị giác</h3>
                  <p className="text-pink-700 leading-relaxed">
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-pink-600 mb-3">Xúc giác</h3>
                  <p className="text-pink-700 leading-relaxed">
            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-pink-600 mb-3">Thị giác</h3>
                  <p className="text-pink-700 leading-relaxed">
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-pink-600 mb-3">Thính giác</h3>
                  <p className="text-pink-700 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 items-center">
            ...
            <div className="text-center">
              <img src="/OIP.jpg" alt="Award 1" className="w-32 h-40 object-contain mx-auto mb-4" />
              <p className="text-pink-700 text-sm font-medium">Giải thưởng The Guide Awards (2012)</p>
            </div>
            <div className="text-center">
              <img src="/OIP.jpg" alt="Award 2" className="w-32 h-40 object-contain mx-auto mb-4" />
              <p className="text-pink-700 text-sm font-medium">Năm 2012 Sen Spa đạt Top 5 Spa đạt chuẩn "TP.HCM 100 điều thú vị" lần II.</p>
            </div>
            <div className="text-center">
              <img src="/OIP.jpg" alt="Award 3" className="w-32 h-40 object-contain mx-auto mb-4" />
      ...
      <section className="py-0">
        <div className="grid grid-cols-4 grid-rows-2">
          ...
          <div className="relative group overflow-hidden">
            <img src="/OIP.jpg" alt="Tầng 1" className="w-full h-full object-cover group-hover:scale-105 transition" />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
              <span className="text-white font-medium">Tầng 1</span>
            </div>
          </div>
          <div className="relative group overflow-hidden">
            <img src="/OIP.jpg" alt="Tầng 2" className="w-full h-full object-cover group-hover:scale-105 transition" />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
              <span className="text-white font-medium">Tầng 2</span>
            </div>
          </div>
          <div className="relative group overflow-hidden">
            <img src="/OIP.jpg" alt="Tầng 3" className="w-full h-full object-cover group-hover:scale-105 transition" />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
          ...
          {/* Floor Images Row 2 */}
          <div className="relative group overflow-hidden">
            <img src="/OIP.jpg" alt="Tầng 4" className="w-full h-full object-cover group-hover:scale-105 transition" />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
              <span className="text-white font-medium">Tầng 4</span>
            </div>
          </div>
          <div className="relative group overflow-hidden">
            <img src="/OIP.jpg" alt="Tầng 5" className="w-full h-full object-cover group-hover:scale-105 transition" />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
              <span className="text-white font-medium">Tầng 5</span>
            </div>
          </div>
          <div className="relative group overflow-hidden">
            <img src="/OIP.jpg" alt="Tầng 6" className="w-full h-full object-cover group-hover:scale-105 transition" />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
